...
seges_cgial_fornecedor.dbo._FORNECEDOR_CONTRATO_ITEM_TERMO_ADITIVO (
    ...
    DS_UNDD_ORGAO_SUP  varchar(100) COLLATE Latin1_General_CI_AS NULL,
    ID_UNDD_UNID_RESP_CONT float NULL,
    NOME_UNID_RESP_CONT varchar(100) COLLATE Latin1_General_CI_AS NULL,
	...
	DS_CNTR_OBJ_CONT varchar(600) COLLATE Latin1_General_CI_AS NULL,
    ...
    DS_TMAD_OBJ_TERMO_ADIT varchar(600) COLLATE Latin1_General_CI_AS NULL,
...
INDICES = """
CREATE NONCLUSTERED INDEX IX_FORNECEDOR_CONTRATO_ITEM_TERMO_ADITIVO_ID_TMAD ON FORNECEDOR_CONTRATO_ITEM_TERMO_ADITIVO (ID_TMAD_TERMO_ADITIVO);
CREATE NONCLUSTERED INDEX IX_FORNECEDOR_CONTRATO_ITEM_TERMO_ADITIVO_ID_CNTR ON FORNECEDOR_CONTRATO_ITEM_TERMO_ADITIVO (ID_CNTR_CONTRATO);
"""