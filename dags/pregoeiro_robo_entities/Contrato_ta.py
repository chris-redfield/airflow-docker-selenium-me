...
seges_cgial_fornecedor.dbo._FORNECEDOR_CONTRATO_ITEM_TERMO_ADITIVO (
	CH_TMAD_TERMO_ADIT_EDIT varchar (500) COLLATE Latin1_General_CI_AS NOT NULL,
    ID_TMAD_TERMO_ADITIVO  float NOT NULL,
	NR_TMAD_IDENT_TERMO_ADIT  float NOT NULL,
    ID_CNTR_CONTRATO float NOT NULL,
	CH_CNTR_IDENT_CONTRATO_EDIT varchar (500) COLLATE Latin1_General_CI_AS NULL, 
	NR_CNTR_IDENT_CONTRATO float NOT NULL,
    ID_UNDD_ORGAO_SUP float NULL,
    DS_UNDD_ORGAO_SUP  varchar(500) COLLATE Latin1_General_CI_AS NULL,
    ID_UNDD_UNID_RESP_CONT float NULL,
    NOME_UNID_RESP_CONT varchar(500) COLLATE Latin1_General_CI_AS NULL,
    ESFERA varchar (500) COLLATE Latin1_General_CI_AS NULL,
    PODER varchar (500) COLLATE Latin1_General_CI_AS NULL,
    TIPO_ADMINISTRACAO varchar (500) COLLATE Latin1_General_CI_AS NULL,
	DS_LCAL_UF varchar (50) COLLATE Latin1_General_CI_AS NULL,
	ID_LCAL_MUNICIPIO_UNIDADE float NULL,
	DS_LCAL_MUNICIPIO varchar (500) COLLATE Latin1_General_CI_AS NULL,
	DS_CNTR_OBJ_CONT varchar(500) COLLATE Latin1_General_CI_AS NULL,
	DS_CNTR_SIT_ATUAL_CONTRATO varchar (500) COLLATE Latin1_General_CI_AS NULL,
	ID_FRND_FORNECEDOR_COMPRA_CONTRATO varchar(50) COLLATE Latin1_General_CI_AS NULL,
	NO_FRND_FORNECEDOR_CONTRATO varchar(500) COLLATE Latin1_General_CI_AS NULL,
	DS_CMPR_MODALIDADE_COMPRA varchar (500) COLLATE Latin1_General_CI_AS NULL,
	TIPO_CONTRATO varchar (500) COLLATE Latin1_General_CI_AS NULL,
    DS_TMAD_OBJ_TERMO_ADIT varchar(500) COLLATE Latin1_General_CI_AS NULL,
	DS_TMAD_TP_TERMO_ADITIVO varchar (500) COLLATE Latin1_General_CI_AS NULL,
	DS_TMAD_TP_VALOR_TERMO varchar (500) COLLATE Latin1_General_CI_AS NULL,
